...
public class AddTax extends JPanel {
	/**
	 * 
	 */
	...
	public AddTax() {
		...
		JLabel lblEnterTheTax = new JLabel("Enter the Tax account number");
		lblEnterTheTax.setHorizontalAlignment(SwingConstants.CENTER);
		lblEnterTheTax.setBounds(147, 11, 168, 14);
		add(lblEnterTheTax);
