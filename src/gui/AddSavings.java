...
public class AddSavings extends JPanel {
	/**
	 * 
	 */
	...
	public AddSavings() {
		...
		JLabel lblEnterTheSavings = new JLabel("Enter the savings account number");
		lblEnterTheSavings.setHorizontalAlignment(SwingConstants.CENTER);
		lblEnterTheSavings.setBounds(147, 11, 168, 14);
		add(lblEnterTheSavings);
